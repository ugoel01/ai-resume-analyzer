...
def display_jobs(job_title):
    # Call the scrape_jobs function and get job information
    scrape_jobs(job_title)
    
    # Convert the job data to a DataFrame for easy display
...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='mysql123@ujjawal',db='cv')
            ...
            if resume_data:
                ...
                for i in resume_data['skills']:
                    ...
                    if i.lower() in ds_keyword:
                        ...
                        st.success("** Our analysis says you are looking for Data Science Jobs, We have recommended one for you.**")
                        display_jobs(reco_field)
                    ...
                    #### Web development recommendation
                        ...
                        st.success("** Our analysis says you are looking for Web Development Jobs and following are recommended.**")
                        display_jobs(reco_field)
                    ...
                    #### Android App Development
                        ...
                        st.success("** Our analysis says you are looking for Android Development Jobs and following are recommended.**")
                        display_jobs(reco_field)
                    ...
                    #### IOS App Development
                        ...
                        st.success("** Our analysis says you are looking for IOS Development Jobs and following are recommended.**")
                        display_jobs(reco_field)
                    ...
                    #### Ui-UX Recommendation
                        ...
                        st.success("** Our analysis says you are looking for UI-UX Jobs and following are recommended.**")
                        display_jobs(reco_field)
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome back ! Total %d " % values + " User's Have Used Our Tool : )")                
                ...
                cursor.execute("SELECT distinct(Name), convert(Predicted_Field using utf8) FROM user_data")
                data = cursor.fetchall()

                df = pd.DataFrame(data, columns=['Name', 'Predicted Field'])
                st.dataframe(df)
                ...
                cursor.execute("SELECT distinct(Name), convert(User_level using utf8) FROM user_data")
                data = cursor.fetchall()

                df = pd.DataFrame(data, columns=['Name', 'Experience level'])
                st.dataframe(df)
                ...
                cursor.execute("SELECT distinct(Name), resume_score FROM user_data")
                data = cursor.fetchall()

                df = pd.DataFrame(data, columns=['Name', 'ATS Score'])
                st.dataframe(df)
